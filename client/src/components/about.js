        ...
        <section class="New_Department row">
            ...
            <nav class="side_navigation col-lg-3">
                <ul class="list-group sidenav_list">
                    <li><a class="list-group-item list-group-item-action active" data-toggle="list" href="#Info1">Hospital</a></li>
                    <li><a class="list-group-item list-group-item-action" data-toggle="list" href="#Info2">History</a></li>
                    <li><a class="list-group-item list-group-item-action" data-toggle="list" href="#Info3">Organogram</a></li>
                    <li><a class="list-group-item list-group-item-action" data-toggle="list" href="#Info4">Past Deans</a></li>
                    <li><a class="list-group-item list-group-item-action" data-toggle="list" href="#Info5">Superintendent</a></li>
                    <li><a class="list-group-item list-group-item-action" data-toggle="list" href="#Info6">Committees</a></li>
                </ul>
            </nav>
            ...
            <div class="tab-content">
              ...
              this.state.show.hospital.type.map(r=>{
                ...
                <h3>History</h3>
                  ...
                  <img src="http://www.bjmcpune.org/oldbj1.jpg" alt="" class="img-fluid"/>
                <img src="http://www.bjmcpune.org/bjmc.jpg" alt="" class="img-fluid"/><br/><br/>
                  ...
                  <img src="http://www.bjmcpune.org/bjmc2.jpg" alt="" class="img-fluid"/>
